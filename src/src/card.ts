...
export default function cardStyle(data: GetData, uiConfig: UiConfig): string {
  ...
  if (selectLocale.rtl || selectLocale.rtl == "true" || selectLocale.rtl == true) {
    ...
    <g transform="translate(0, 25)">
        <g class="div-animation">
        	<text x="510" y="-10" class="text-title">${selectLocale.titleCard.split("{name}").join(data.name)}</text>
        </g>
        ...
        <svg x="-10" y="12">
            <g transform="translate(230, 0)">
                <g class="single-item-animation" style="animation-delay: 210ms" transform="translate(25, 0)">
                    <svg x="225" y="0" class="icon" viewBox="0 0 16 16" version="1.1" width="16" height="16">
                        <path fill-rule="evenodd" d="M2 2.5A2.5 2.5 0 014.5 0h8.75a.75.75 0 01.75.75v12.5a.75.75 0 01-.75.75h-2.5a.75.75 0 110-1.5h1.75v-2h-8a1 1 0 00-.714 1.7.75.75 0 01-1.072 1.05A2.495 2.495 0 012 11.5v-9zm10.5-1V9h-8c-.356 0-.694.074-1 .208V2.5a1 1 0 011-1h8zM5 12.25v3.25a.25.25 0 00.4.2l1.45-1.087a.25.25 0 01.3 0L8.6 15.7a.25.25 0 00.4-.2v-3.25a.25.25 0 00-.25-.25h-3.5a.25.25 0 00-.25.25z"/>
                    </svg>
                    <text class="text" x="215" y="12.5">${selectLocale.totalReposText}:</text>
                    <text class="text text-bold" x="15" y="12.5">${data.public_repos}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 25)">
                <g class="single-item-animation" style="animation-delay: 350ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="215" y="12.5">${selectLocale.starsCountText}:</text>
                    <text class="text text-bold" x="15" y="12.5">${data.total_stars}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 50)">
                <g class="single-item-animation" style="animation-delay: 460ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="215" y="12.5">${selectLocale.forksCountText}:</text>
                    <text class="text text-bold" x="15" y="12.5">${data.total_forks}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 75)">
                <g class="single-item-animation" style="animation-delay: 560ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="215" y="12.5">${selectLocale.commitsCountText}:</text>
                    <text class="text text-bold" x="15" y="12.5">${data.total_commits}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 100)">
                <g class="single-item-animation" style="animation-delay: 660ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="215" y="12.5">${selectLocale.totalPRText}:</text>
                    <text class="text text-bold" x="15" y="12.5">${data.total_prs}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 125)">
                <g class="single-item-animation" style="animation-delay: 760ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="215" y="12.5">${selectLocale.totalPRMergedText}:</text>
                    <text class="text text-bold" x="15" y="12.5">${data.total_prs_merged}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 150)">
                <g class="single-item-animation" style="animation-delay: 760ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="215" y="12.5">${selectLocale.totalIssuesText}:</text>
                    <text class="text text-bold" x="15" y="12.5">${data.total_issues}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 175)">
                <g class="single-item-animation" style="animation-delay: 760ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="215" y="12.5">${selectLocale.contributedToText}:</text>
                    <text class="text text-bold" x="15" y="12.5">${data.total_contributed_to}</text>
                </g>
            </g>
        </svg>
    </g>
    ...
    <g transform="translate(0, 25)">
        <g class="div-animation">
        	<text x="5" y="-10" class="text-title">${selectLocale.titleCard.split("{name}").join(data.name)}</text>
        </g>
        <g class="image-profile-animation">
        	<defs>
               <pattern id="image" x="0%" y="0%" height="100%" width="100%" viewBox="0 0 512 512">
        ...
        <svg x="-10" y="12">
            <g transform="translate(230, 0)">
                <g class="single-item-animation" style="animation-delay: 210ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${selectLocale.totalReposText}:</text>
                    <text class="text text-bold" x="225" y="12.5">${data.public_repos}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 25)">
                <g class="single-item-animation" style="animation-delay: 350ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${selectLocale.starsCountText}:</text>
                    <text class="text text-bold" x="225" y="12.5">${data.total_stars}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 50)">
                <g class="single-item-animation" style="animation-delay: 460ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${selectLocale.forksCountText}:</text>
                    <text class="text text-bold" x="225" y="12.5">${data.total_forks}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 75)">
                <g class="single-item-animation" style="animation-delay: 560ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${selectLocale.commitsCountText}:</text>
                    <text class="text text-bold" x="225" y="12.5">${data.total_commits}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 100)">
                <g class="single-item-animation" style="animation-delay: 660ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${selectLocale.totalPRText}:</text>
                    <text class="text text-bold" x="225" y="12.5">${data.total_prs}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 125)">
                <g class="single-item-animation" style="animation-delay: 760ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${selectLocale.totalPRMergedText}:</text>
                    <text class="text text-bold" x="225" y="12.5">${data.total_prs_merged}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 150)">
                <g class="single-item-animation" style="animation-delay: 760ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${selectLocale.totalIssuesText}:</text>
                    <text class="text text-bold" x="225" y="12.5">${data.total_issues}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 175)">
                <g class="single-item-animation" style="animation-delay: 760ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="25" y="12.5">${selectLocale.contributedToText}:</text>
                    <text class="text text-bold" x="225" y="12.5">${data.total_contributed_to}</text>
                </g>
            </g>
        </svg>
    </g>
