...
export default function cardStyle(data: GetData, uiConfig: UiConfig): string {
  ...
  if (selectLocale.rtlDirection == "true" || selectLocale.rtlDirection) {
    var cardsUi: CardsUi = {
      direction: "rtl",
      titleXAngle: 510,
      titleYAngle: -10,
  ...
  if (uiConfig.disabledAnimations == "true" || uiConfig.disabledAnimations) {
    var animations = "";
    var cardsUi: CardsUi = {
      direction: "ltr",
      titleXAngle: 15,
  ...
  var card = `<svg width="535" height="245" viewBox="0 0 535 245" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <g transform="translate(0, 25)">
        <g class="div-animation">
            <text x="${cardsUi.titleXAngle}" y="${cardsUi.titleYAngle}" direction="${cardsUi.direction}" class="text-title">${selectLocale.titleCard.split("{name}").join(data.name) || defaultLocale.titleCard.split("{name}").join(data.name)}</text>
        </g>
        ...
        <g class="div-animation text-middle">
            <text x="${cardsUi.follXAngle}" y="${cardsUi.follYAngle}" direction="${cardsUi.direction}" class="text-followers"><tspan class="text-bold">${data.followers}</tspan> ${selectLocale.followersText || defaultLocale.followersText} · <tspan class="text-bold">${data.following}</tspan> ${selectLocale.followingText || defaultLocale.followingText}</text>
        </g>
        ...
        <svg x="-10" y="12">
            <g transform="translate(230, 0)">
                <g class="single-item-animation" style="animation-delay: 210ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${cardsUi.textXAngle}" y="${cardsUi.textYAngle}" direction="${cardsUi.direction}">${selectLocale.totalReposText || defaultLocale.totalReposText}:</text>
                    <text class="text text-bold" x="${cardsUi.dataXAngle}" y="${cardsUi.dataYAngle}" direction="${cardsUi.direction}">${data.public_repos}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 25)">
                <g class="single-item-animation" style="animation-delay: 350ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${cardsUi.textXAngle}" y="${cardsUi.textYAngle}" direction="${cardsUi.direction}">${selectLocale.starsCountText || defaultLocale.starsCountText}:</text>
                    <text class="text text-bold" x="${cardsUi.dataXAngle}" y="${cardsUi.dataYAngle}" direction="${cardsUi.direction}">${data.total_stars}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 50)">
                <g class="single-item-animation" style="animation-delay: 460ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${cardsUi.textXAngle}" y="${cardsUi.textYAngle}" direction="${cardsUi.direction}">${selectLocale.forksCountText || defaultLocale.forksCountText}:</text>
                    <text class="text text-bold" x="${cardsUi.dataXAngle}" y="${cardsUi.dataYAngle}" direction="${cardsUi.direction}">${data.total_forks}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 75)">
                <g class="single-item-animation" style="animation-delay: 560ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${cardsUi.textXAngle}" y="${cardsUi.textYAngle}" direction="${cardsUi.direction}">${selectLocale.commitsCountText || defaultLocale.commitsCountText}:</text>
                    <text class="text text-bold" x="${cardsUi.dataXAngle}" y="${cardsUi.dataYAngle}" direction="${cardsUi.direction}">${data.total_commits}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 100)">
                <g class="single-item-animation" style="animation-delay: 660ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${cardsUi.textXAngle}" y="${cardsUi.textYAngle}" direction="${cardsUi.direction}">${selectLocale.totalPRText || defaultLocale.totalPRText}:</text>
                    <text class="text text-bold" x="${cardsUi.dataXAngle}" y="${cardsUi.dataYAngle}" direction="${cardsUi.direction}">${data.total_prs}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 125)">
                <g class="single-item-animation" style="animation-delay: 760ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${cardsUi.textXAngle}" y="${cardsUi.textYAngle}" direction="${cardsUi.direction}">${selectLocale.totalPRMergedText || defaultLocale.totalPRMergedText}:</text>
                    <text class="text text-bold" x="${cardsUi.dataXAngle}" y="${cardsUi.dataYAngle}" direction="${cardsUi.direction}">${data.total_prs_merged}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 150)">
                <g class="single-item-animation" style="animation-delay: 860ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${cardsUi.textXAngle}" y="${cardsUi.textYAngle}" direction="${cardsUi.direction}">${selectLocale.totalIssuesText || defaultLocale.totalIssuesText}:</text>
                    <text class="text text-bold" x="${cardsUi.dataXAngle}" y="${cardsUi.dataYAngle}" direction="${cardsUi.direction}">${data.total_issues}</text>
                </g>
            </g>
            ...
            <g transform="translate(230, 175)">
                <g class="single-item-animation" style="animation-delay: 960ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${cardsUi.textXAngle}" y="${cardsUi.textYAngle}" direction="${cardsUi.direction}">${selectLocale.contributedToText || defaultLocale.contributedToText}:</text>
                    <text class="text text-bold" x="${cardsUi.dataXAngle}" y="${cardsUi.dataYAngle}" direction="${cardsUi.direction}">${data.total_contributed_to}</text>
                </g>
            </g>
        </svg>
    </g>
