...
export default function cardStyle(data: GetData, uiConfig: UiConfig): string {
  ...
  var cardAnimations = `<svg width="535" height="245" direction="${direction}" viewBox="0 0 535 245" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <style>
        /* Animations */
    ...
    <g transform="translate(0, 25)">
        ...
        <g class="div-animation text-middle">
            <text x="110" y="151" class="text-followers"><tspan class="text-bold">${data.followers}</tspan> ${selectLocale.followersText || defaultLocale.followersText} · <tspan class="text-bold">${data.following}</tspan> ${selectLocale.followingText || defaultLocale.followingText}</text>
        </g>
        ...
        <svg x="-10" y="12">
            <g transform="translate(230, 0)">
                <g class="single-item-animation" style="animation-delay: 210ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${textXAngle}" y="12.5">${selectLocale.totalReposText || defaultLocale.totalReposText}:</text>
            ...
            <g transform="translate(230, 25)">
                <g class="single-item-animation" style="animation-delay: 350ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${textXAngle}" y="12.5">${selectLocale.starsCountText || defaultLocale.starsCountText}:</text>
            ...
            <g transform="translate(230, 50)">
                <g class="single-item-animation" style="animation-delay: 460ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${textXAngle}" y="12.5">${selectLocale.forksCountText || defaultLocale.forksCountText}:</text>
            ...
            <g transform="translate(230, 75)">
                <g class="single-item-animation" style="animation-delay: 560ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${textXAngle}" y="12.5">${selectLocale.commitsCountText || defaultLocale.commitsCountText}:</text>
            ...
            <g transform="translate(230, 100)">
                <g class="single-item-animation" style="animation-delay: 660ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${textXAngle}" y="12.5">${selectLocale.totalPRText || defaultLocale.totalPRText}:</text>
            ...
            <g transform="translate(230, 125)">
                <g class="single-item-animation" style="animation-delay: 760ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${textXAngle}" y="12.5">${selectLocale.totalPRMergedText || defaultLocale.totalPRMergedText}:</text>
            ...
            <g transform="translate(230, 150)">
                <g class="single-item-animation" style="animation-delay: 860ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${textXAngle}" y="12.5">${selectLocale.totalIssuesText || defaultLocale.totalIssuesText}:</text>
            ...
            <g transform="translate(230, 175)">
                <g class="single-item-animation" style="animation-delay: 960ms" transform="translate(25, 0)">
                    ...
                    <text class="text" x="${textXAngle}" y="12.5">${selectLocale.contributedToText || defaultLocale.contributedToText}:</text>
  ...
  var cardAnimationsDisabled = `<svg width="535" height="245" direction="${direction}" viewBox="0 0 535 245" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    <style>
        .text {
            font-family: "Segoe UI", Ubuntu, sans-serif;
            fill: #${uiConfig.textColor};
    ...
    <g transform="translate(0, 25)">
        <g class="div-animation">
            <text x="${titleXAngle}" y="0" class="text-title">${selectLocale.titleCard.split("{name}").join(data.name) || defaultLocale.titleCard.split("{name}").join(data.name)}</text>
        </g>
        <g class="image-profile-animation">
            <defs>
                <pattern id="image" x="0%" y="0%" height="100%" width="100%" viewBox="0 0 512 512">
            ...
            <circle cx="120" cy="70" r="50" fill="url(#image)" stroke="#${uiConfig.strokeColor}" stroke-width="5"/>
        </g>
        <text x="119.9" y="140" direction="ltr" class="text-username div-animation">@${data.username}</text>
        <g class="div-animation text-middle">
            <text x="120" y="161" class="text-followers"><tspan class="text-bold">${data.followers}</tspan> ${selectLocale.followersText || defaultLocale.followersText} · <tspan class="text-bold">${data.following}</tspan> ${selectLocale.followingText || defaultLocale.followingText}</text>
        </g>
  ...
  if (uiConfig.disabledAnimations == "true" || uiConfig.disabledAnimations) {
    var card = cardAnimationsDisabled;
  } else {
    var card = cardAnimations;
  };
  if (uiConfig.Format == "png") {
    var card = cardAnimationsDisabled;
  };
